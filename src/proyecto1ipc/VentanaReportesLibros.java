 ...
 * @author Fernando
 */
public class VentanaReportesLibros extends javax.swing.JFrame {
   ...
   static int contador = 0;
    ...
    private void initComponents() {
        ...
        JButtonRegistroLibros.setText("Reporte libros");
   ...
   //le quite el static porque daba errores
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReportesLibros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaReportesLibros().setVisible(true);
